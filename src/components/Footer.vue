    ...
    <div class="w-full px-8 mx-auto max-w-7xl">
      ...
      >
        <p class="block mb-4 text-sm text-center text-slate-500 md:mb-0">
          Copyright © 2024
          <a href="#">Alaudin Hujdur</a>. All Rights Reserved.
        </p>
        <div class="flex gap-4 text-slate-600 sm:justify-center">
          <a
            href="https://www.facebook.com/glazbenivrtic.mostar"
            target="_blank"
          ...
          <a
            href="https://www.instagram.com/glazbene_radionice_mostar/"
            target="_blank"
            class="block transition-opacity text-inherit hover:opacity-80"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a
            href="https://api.whatsapp.com/send?phone=38761631226"
            target="_blank"
            class="block transition-opacity text-inherit hover:opacity-80"
          >
            <svg class="w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fill-rule="evenodd"
